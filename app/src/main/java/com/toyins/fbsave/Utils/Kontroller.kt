package com.toyins.fbsave.Utils
...
import com.toyins.fbsave.Bounds
import com.toyins.fbsave.Lecturer
import com.toyins.fbsave.MainActivity
import com.toyins.fbsave.Player.PhotoPlayer
import com.toyins.fbsave.Player.VideoPlayer
import com.toyins.fbsave.SaveService.Saviour
    ...
    var mDialog = FeedBackDialog(context)
            ...
            .setOnReviewClickListener(object : FeedBackActionsListeners{
                ...
                override fun onPositiveFeedback(dialog: FeedBackDialog?) {
                    ...
                    val ints = Intent(context,Saviour::class.java)
